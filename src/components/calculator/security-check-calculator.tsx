...
export function SecurityCheckCalculator() {
  ...
  return (
    <div style={{ viewTransitionName: "security-calculator-module" }}
    className="rounded-2xl border border-[oklch(0.89_0.008_260/0.55)] bg-[oklch(0.968_0.004_260)] p-8 shadow-[0_8px_24px_-4px_oklch(0.16_0.02_260/0.04)] @container">
      ...
      <form action={formAction} className="mt-8 space-y-8">
        ...
        <fieldset className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3 @sm:grid-cols-3">
            {[
              ...
              <label key={option.id} className="relative flex cursor-pointer rounded-xl border border-[oklch(0.89_0.008_260/0.55)] bg-[oklch(0.988_0.002_260)] p-4 shadow-sm hover:border-[oklch(0.52_0.24_260/0.5)] transition-colors ease-[cubic-bezier(0.16,1,0.3,1)] motion-reduce:transition-none focus-within:ring-2 focus-within:ring-[oklch(0.52_0.24_260/0.5)] focus-within:ring-offset-2 focus-within:ring-offset-[oklch(0.988_0.002_260)]">
        ...
        <button
          type="submit"
          disabled={isPending}
          className="w-full rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[oklch(0.52_0.24_260)] focus-visible:ring-offset-2 focus-visible:ring-offset-[oklch(0.988_0.002_260)] bg-[oklch(0.52_0.24_260)] py-4 text-[15px] font-semibold text-white shadow-sm transition-all ease-[cubic-bezier(0.16,1,0.3,1)] motion-reduce:transition-none hover:bg-[oklch(0.48_0.24_260)] active:scale-[0.99] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
          {isPending ? (
            <>
