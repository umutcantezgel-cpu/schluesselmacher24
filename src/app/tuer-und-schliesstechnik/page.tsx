...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: page?.seo.title ?? 'Tür- & Schließtechnik: Sicherheit vom Zylinder',
    description:
      page?.seo.description
      ?? 'Ganzheitliche Tür- und Schließtechnik. Beratung, Montage und Reparatur von Zylindern, Mehrfachverriegelungen und Beschlägen. Erhöhen Sie Ihre Sicherheit.',
...
export default async function TuerUndSchliesstechnikPage(props: Props) {
  ...
  const pageTitle = page?.seo.title ?? 'Tür- & Schließtechnik: Sicherheit vom Zylinder';
  ...
  return (
    ...
    >
      ...
      <JsonLd data={faqSchema(EXPERT_FAQ.map((g) => ({ question: g.question, answer: g.answer })), `${getSiteUrl()}/${ROUTE}`)} />
